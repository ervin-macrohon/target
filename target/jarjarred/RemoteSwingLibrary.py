...
class RemoteSwingLibrary(object):
    ...
    def _create_env(self, close_security_dialogs=False, remote_port=0):
        ...
        #agent_command = '-javaagent:"%s"=127.0.0.1:%s' % ('C:\\Users\\ervin.macrohon\\workspace\\remoteswinglibrary-master\\src\\test\\robotframework\\acceptance\\webstart\\test-app\\test-application.jar', RemoteSwingLibrary.PORT)
        if int(remote_port):
